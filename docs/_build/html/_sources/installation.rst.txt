...
.. note::
    ...
    All versions were used at developement time and later or previous versions of each package may work.
...
.. note::
    ...
    The tarball is not meant to be updated by users. If you wish to update pywinds manually,
    install the package into a conda environment (see below).
