...
winds = wind_info(lat_0, lon_0, 100, shape=(1000, 1000), displacement_data=None, i=j_in, j=i_in,
                  pixel_size=pixel_size,  center=center, earth_geod=earth_geod, image_geod=image_geod,
                  save_data=False).transpose().reshape((6, 1000, 1000))
print(winds[:, 400, 400])
...
#
# output_vu = vu(lat_0, lon_0, 100, i=i_in, j=j_in, pixel_size=pixel_size, center=center,
...
old_lat_long = lat_long(lat_0, lon_0, i=i_in, j=j_in, pixel_size=pixel_size, center=center,
                        shape=(1000,1000), image_geod=image_geod, save_data=save_data)
